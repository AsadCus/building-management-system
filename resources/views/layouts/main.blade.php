...
<head>
    ...
    <title>Building Management System - MNC</title>
...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
    <div class="flex overflow-hidden">
        <nav class="side-nav">
            <a href="/dashboard" class="intro-x flex items-center pl-5 pt-4 mt-3">
                <img alt="" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
                <span class="hidden xl:block text-white text-lg ml-3"> BMS </span>
            </a>
            <div class="side-nav__devider my-6"></div>
            <ul>
                <li>
                    <a href="javascript:;"
                        class="side-menu {{ (request()->is('maintenance')) || (request()->is('building')) ? 'side-menu--active' : '' }}">
                        ...
                        <div class="side-menu__title">
                            Master
                            <div
                                class="side-menu__sub-icon {{ (request()->is('maintenance')) || (request()->is('building')) ? 'transform rotate-180' : '' }}">
                    ...
                    <ul class="{{ (request()->is('maintenance')) || (request()->is('form')) || (request()->is('value')) || (request()->is('building')) || (request()->is('floor')) || (request()->is('room')) ? 'side-menu__sub-open' : '' }}">
                        <li>
                            <a href="{{Route('maintenance.get.view')}}" class="side-menu {{ Route::currentRouteName() == 'maintenance.get.view' ? " side-menu--active"
                                : "" }}">
                                <div class="side-menu__icon">
                                ...
                                <div class="side-menu__title"> Maintenance </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{Route('form.get.view')}}" class="side-menu {{ Route::currentRouteName() == 'form.get.view' ? " side-menu--active"
                                : "" }}">
                                <div class="side-menu__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <li>
                            <a href="{{Route('value.get.view')}}" class="side-menu {{ Route::currentRouteName() == 'value.get.view' ? " side-menu--active"
                                : "" }}">
                                <div class="side-menu__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <li>
                            <a href="{{Route('building.get.view')}}" class="side-menu {{(request()->is('building')) ? "
                                side-menu--active" : "" }}">
                                <div class="side-menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
                                        <path
                                ...
                                <div class="side-menu__title"> Building </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{Route('floor.get.view')}}" class="side-menu {{(request()->is('floor')) ? "
                                side-menu--active" : "" }}">
                                <div class="side-menu__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                        class="bi bi-building-exclamation" viewBox="0 0 16 16">
                                        <path
                                ...
                                <div class="side-menu__title"> Floor </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{Route('room.get.view')}}" class="side-menu {{(request()->is('room')) ? "
                                side-menu--active" : "" }}">
                                <div class="side-menu__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                        class="bi bi-building-exclamation" viewBox="0 0 16 16">
                ...
                <div class="intro-x dropdown w-8 h-8">
                    ...
                    <div class="dropdown-menu w-56">
                        <ul class="dropdown-content bg-primary text-white">
                            <li class="p-2">
                                <div class="font-medium capitalize">{{ Auth::user()->name }}</div>
                                <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">Admin(Role)</div>
                            </li>
                            <li>
