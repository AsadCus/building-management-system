...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Edit Maintenance</h2>
</div>

<!-- BEGIN: Form Layout -->
<form id="editMaintenance" action="{{ Route('maintenance.put.update') }}" method="post" class="intro-y box p-5 mt-5">
    @csrf
    @method('put')
    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
        ...
        <div class="mt-3">
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    <input id="" name="maintenance" type="text" class="form-control capitalize" placeholder="Maintenance name" value="{{ $maintenance->maintenance }}" required>
        ...
        <div class="mt-3">
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    ...
                    <textarea class="w-full p-2 rounded" name="description" id="" rows="5" required>{{ $maintenance->description }}</textarea>
                    {{-- <div class="form-help text-right">Maximum character 0/70</div> --}}
                </div>
            </div>
        </div>
        <div class="mt-3">
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    <input id="" name="frequency" type="text" class="form-control capitalize" placeholder="Daily, Weekly, etc" value="{{ $maintenance->frequency }}" required>
                    {{-- <div class="form-help text-right">Maximum character 0/70</div> --}}
                </div>
            </div>
        </div>
...
<div class="flex justify-end flex-row gap-2 mt-5">
    ...
    <button form="editMaintenance" class="btn py-3 btn-primary md:w-52">Save Edit</button>
</div>
