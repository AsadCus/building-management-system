...
<nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ Route('value.get.view') }}">Value</a></li>
    </ol>
</nav>
@endsection
@section('content')
...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Add Value</h2>
</div>

<!-- BEGIN: Form Layout -->
<form id="createValue" action="{{ Route('value.post.store') }}" method="post" class="intro-y box p-5 mt-5">
    @csrf
    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
        ...
        <div class="mt-3">
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    <input id="" name="maintenance_id" type="text" class="form-control" placeholder="Form" required>
        ...
        <div class="mt-3">
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    <input id="" name="value" type="text" class="form-control capitalize" required>
                    {{-- <div class="form-help text-right">Maximum character 0/70</div> --}}
                </div>
            </div>
        </div>
