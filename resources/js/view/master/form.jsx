...
function Forms() {
    ...
    const columns = React.useMemo(
        ...
        () => [
        {
            ...
            Cell: tableProps => (
                <a href='#' className='text-primary text-center'>{tableProps.row.original.maintenance.maintenance}/{tableProps.row.original.maintenance_id}</a>
            )
        },
        {
            Header: 'Title',
            accessor: 'title_name',
            Cell: tableProps => (
                <a href='#' className='text-primary text-center capitalize'>{tableProps.row.original.title}</a>
            )
        },
        {
            Header: 'Subtitle',
            accessor: 'subtitle',
            Cell: tableProps => (
                <p>{tableProps.row.original.subtitle}</p>
            )
        },
        {
            Header: 'Placeholder',
            ...
            Cell: tableProps => (
                <p>{tableProps.row.original.placeholder}</p>
            )
        },
        {
            Header: 'Hint',
            accessor: 'hint',
            Cell: tableProps => (
                <p>{tableProps.row.original.hint}</p>
            )
        },
        {
            Header: 'Type',
        ...
        },
        {
            ...
            Cell: tableProps => (
                <p>{tableProps.row.original.is_mandatory.toString()}</p>
            )
        },
        {
            Header: 'Additional Value',
            accessor: 'additional_value',
            Cell: tableProps => (
                <p>{tableProps.row.original.additional_value}</p>
            )
        },
        {
                    ...
                    <div className="border-l-2">
                        ...
                        >
                            <a
                                ...
                                href={"/form/edit/" + tableProps.row.original.id}
                            >
                                <svg
...
if (document.getElementById("master-form")) {
    ReactDOM.render(<Forms />, document.getElementById("master-form"));
}
