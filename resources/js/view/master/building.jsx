        ...
        () => [
            {
                ...
                Cell: tableProps => (
                    <>
                        <a href='#' className='text-primary'>{tableProps.row.original.location_name}</a>
                    </>
                )
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary'>{tableProps.row.original.regional}</p>
                    </>
                )
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary'>{tableProps.row.original.address}</p>
                    </>
                )
            },
            {
            ...
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary'>{tableProps.row.original.latitude}</p>
                    </>
                )
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary'>{tableProps.row.original.longitude}</p>
                    </>
                )
            },
        ],
...
if (document.getElementById("master-building")) {
    ReactDOM.render(<Buildings />, document.getElementById("master-building"));
}
