        ...
        () => [
            {
                ...
                Cell: tableProps => (
                    <>
                        <a href='#' className='text-primary'>{tableProps.row.original.loginlocation.location_name}</a>
                    </>
                )
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary capitalize'>{tableProps.row.original.name}</p>
                    </>
                )
            },
            {
            ...
            },
            {
                ...
                Cell: tableProps => (
                    <>
                        <p className='text-primary'>{tableProps.row.original.no_room_category.toString()}</p>
                    </>
                )
            },
        ],
...
if (document.getElementById("master-floor")) {
    ReactDOM.render(<Floors />, document.getElementById("master-floor"));
}
